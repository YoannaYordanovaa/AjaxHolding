...
const SERVICES = [
  {
    ...
    stat: "360°",
    statLabel: "управление",
    description:
      "Предлагаме цялостно управление на инвестиции, посредничество и инвеститорски контрол. Комплексна услуга адаптирана към нуждите на всеки клиент.",
    items: [
      "Планиране и бюджет",
      "Времева рамка",
  ...
  },
  {
    ...
    statLabel: "подход",
    description:
      "Разработваме индивидуални решения изцяло съобразени с нуждите, визията и бюджета на клиента.",
    items: [
      "Консултации",
      "Персонални решения",
  ...
  },
  {
    ...
    num: "05",
    title: "Обзавеждане",
    subtitle: "Ексклузивно за нашите клиенти",
    short: "Дизайн, производство",
    stat: "100%",
    ...
    >
      <div
        style={{
          ...
          transition:
            "opacity 0.32s, transform 0.38s cubic-bezier(0.4,0,0.2,1)",
      ...
      >
        ...
        <div
          style={{
            padding: isMobile ? "1.25rem 1.5rem 2rem" : "2rem 2.5rem 2.5rem",
          }}
        >
          <p
            style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Стойността на услугите се определя спрямо сложността и обема на
          проекта.
        </p>
        <button
          onClick={() =>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(14,11,7,0.95) 0%, rgba(14,11,7,0.25) 55%, transparent 100%)",
          }}
        />
        <div
          style={{
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            justifyContent: "center",
            opacity: vis1 ? 1 : 0,
            transform: vis1 ? "none" : "translateX(-24px)",
        ...
        >
          ...
          <h2
            style={{
              fontFamily: "var(--serif)",
              fontSize: isMobile ? "2rem" : "clamp(2rem,3vw,2.8rem)",
              fontWeight: 400,
              color: "var(--ink)",
              lineHeight: 1.2,
              marginBottom: "1.75rem",
          ...
          >
            Едно от първите
            <br />
            <em style={{ color: "var(--gold)" }}>частни дружества</em>
            <br />в България
          </h2>
          ...
          >
            ...
            най-разнообразно предназначение и сложност. Развивали сме дейността
            си в България и зад граница, изграждайки успешни партньорства с
            утвърдени компании.
          </p>
        </div>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to top, rgba(14,11,7,0.75) 0%, rgba(14,11,7,0.1) 60%)",
            }}
          />
          <div
            style={{
          ...
          >
            ...
            >
              „Опитът ни дава увереност и решителност, че с професионализъм
              можем да се справим с всеки един проект."
            </p>
            <div
              style={{
                width: 36,
      ...
      <div
        ...
        style={{
          ...
          opacity: vis2 ? 1 : 0,
          transform: vis2 ? "none" : "translateY(20px)",
          ...
          {[
            {
              ...
              sub: "Едно от първите частни дружества",
            },
            {
              num: "30+",
              label: "Години опит",
              sub: "В строителство и реновация",
            },
            {
              num: "100+",
              label: "Завършени проекти",
              sub: "В България и чужбина",
            },
            {
              num: "BG+",
              label: "Международно присъствие",
              sub: "Реализирани проекти зад граница",
            },
          ].map((s, i) => (
            <div
              key={s.num}
  ...
  return (
    <section
      ...
      style={{
        background: "var(--cream)",
        borderTop: "1px solid var(--border)",
        padding: isMobile ? "4rem 0 3rem" : "7rem 0 5rem",
      }}
    >
      <div
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            gap: "1rem",
            opacity: hVis ? 1 : 0,
            transform: hVis ? "none" : "translateY(18px)",
            transition: "opacity 0.8s, transform 0.8s",
          }}
        >
          <div>
        ...
        {isMobile ? (
          ...
          >
            ...
            <div
              key={`pt-${active}`}
              style={{ animation: "fadeSlideLeft 0.5s ease" }}
            >
              <div
                style={{
                  display: "flex",
                ...
                {PROJECTS.map((proj, i) => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "0.6rem",
                      letterSpacing: "0.12em",
                      color: i === active ? "var(--gold)" : "var(--border)",
                      cursor: "pointer",
                      transition: "color 0.3s",
                      padding: "0.2rem 0",
                    }}
...
function ContactsSection({ isMobile }) {
  ...
  return (
    <section
      id="contact"
      style={{ background: "#1c1914", padding: isMobile ? "4rem 0" : "7rem 0" }}
    >
      <div
        ref={ref}
        style={{
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
            ...
            {/* Имейл */}
            <a
              href="mailto:office@ajaxholding.bg"
              style={{
                display: "flex",
                alignItems: "center",
                gap: "1.25rem",
    ...
    <div>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        #about, #services, #projects, #contact { scroll-margin-top: -40px; }
      ...
      <HeroAndServices
        isMobile={isMobile}
        onSvcClick={(svc, img) => setModal({ svc, img })}
      />
      <ServicesSection
        isMobile={isMobile}
        onSvcClick={(svc, img) => setModal({ svc, img })}
